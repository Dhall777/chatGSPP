...
def create_milvus_collection(
    ...
    # FLAT - CPU-based, slow as hell but 100% accurate
    # GPU_IVF_FLAT - GPU-based, super quick but not 100% accurate
    index_params = {
        "index_type": "GPU_IVF_FLAT",
        "metric_type": "IP",  # Options: "L2", "IP", "COSINE"
        "params": {
            "nlist": 64,                        # # of cluster units
            "nprobe": 8,                         # # of cluster units to query
            "top-K": 4,                         # Number of returned docs in the search. Higher values can improve recall but may impact speed.
