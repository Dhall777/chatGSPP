...
def split_files_into_chunks(source_dir, output_parent_dir, num_chunks=50, shuffle=True, action='copy'):
    """
...
def main():
    ...
    parser.add_argument('--num_chunks', type=int, default=50, help="Number of subdirectories to create. Default is 50.")
